      ...
      agent {
        ...
        steps {
          container(name: 'kaniko', shell: '/busybox/sh') {
              ...
              ls -la /workspace
              #
              /kaniko/executor --dockerfile=Dockerfile --context=/tmp/jenkins/workspace/test/word-cloud-generator --destination=$AWS_ECR_REPOSITORY_URI:$IMAGE_TAG --verbosity debug
              '''
          }
        }
      }
